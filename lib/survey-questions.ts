...
export const ANSWER_OPTIONS = [
  ...
  { key: 4, label: '꼭 하고 싶다', desc: '반드시 해보고 싶은 것' },
] as const
...
type JobWeight = { job: JobType; weight: 1 | 2 | 3 }
...
export const QUESTIONS: Question[] = [
  ...
  { id: 'c01', text: '광고 성과 지표(CTR, ROAS, CPA 등)가 무엇을 의미하는지 이해하고 싶다', category: 'data',
    jobs: [{ job: 'performance', weight: 3 }, { job: 'growth', weight: 2 }] },
  { id: 'c02', text: '숫자나 표를 보면서 \'왜 이런 결과가 나왔을까?\' 분석하는 게 재미있다', category: 'data',
    jobs: [{ job: 'performance', weight: 3 }, { job: 'growth', weight: 2 }, { job: 'crm', weight: 1 }] },
  ...
  { id: 'c13', text: '광고 소재(이미지, 영상, 카피)가 왜 어떤 건 잘 되고 어떤 건 안 되는지 궁금하다', category: 'ads',
    jobs: [{ job: 'performance', weight: 1 }, { job: 'content', weight: 1 }, { job: 'growth', weight: 2 }, { job: 'ae', weight: 2 }] },
  { id: 'c14', text: 'SNS 계정(인스타, 블로그, 유튜브 등)을 꾸준히 운영해본 적이 있다', category: 'ads',
    jobs: [{ job: 'content', weight: 1 }, { job: 'brand', weight: 1 }] },
  ...
  { id: 'c16', text: '어떤 제품이나 서비스가 \'누구에게\' \'어떤 메시지\'로 광고해야 할지 떠올리는 걸 잘한다', category: 'strategy',
    jobs: [{ job: 'performance', weight: 1 }, { job: 'brand', weight: 2 }] },
  { id: 'c17', text: '하나의 캠페인을 처음부터 끝까지(기획→실행→성과 측정→회고) 진행해보고 싶다', category: 'strategy',
    jobs: [{ job: 'growth', weight: 2 }, { job: 'ae', weight: 2 }] },
  ...
  { id: 'c19', text: '사람들이 앱이나 웹사이트에서 어떤 경로로 구매까지 가는지 흐름을 파악하고 싶다', category: 'growth',
    jobs: [{ job: 'performance', weight: 1 }, { job: 'growth', weight: 2 }, { job: 'crm', weight: 1 }] },
  { id: 'c20', text: '\'왜 이 사람들은 결제를 안 하고 나갈까?\' 같은 문제를 구조적으로 파고드는 게 재미있다', category: 'growth',
    jobs: [{ job: 'performance', weight: 1 }, { job: 'growth', weight: 2 }, { job: 'crm', weight: 2 }] },
  ...
  { id: 'c22', text: '\'어떤 사람에게 어떤 말을 어떤 타이밍에 보낼까?\'를 고민하는 게 재미있다', category: 'people',
    jobs: [{ job: 'content', weight: 1 }, { job: 'crm', weight: 2 }] },
  { id: 'c23', text: '고객을 특성별로 나눠서(세그먼트) 다르게 접근하는 전략을 배워보고 싶다', category: 'people',
    jobs: [{ job: 'growth', weight: 1 }, { job: 'crm', weight: 2 }] },
  ...
  { id: 'c25', text: '여러 일을 동시에 관리하면서 마감을 맞추는 것을 잘한다', category: 'collab',
    jobs: [{ job: 'growth', weight: 1 }, { job: 'ae', weight: 2 }] },
  { id: 'c26', text: '다양한 산업, 다양한 브랜드를 경험하면서 폭넓게 배우는 게 재미있다', category: 'collab',
    jobs: [{ job: 'brand', weight: 2 }, { job: 'ae', weight: 2 }] },
  { id: 'c27', text: '기획한 내용을 발표하거나 글로 설득력 있게 전달하는 것을 잘한다', category: 'collab',
    jobs: [{ job: 'content', weight: 1 }, { job: 'brand', weight: 1 }, { job: 'ae', weight: 1 }] },
  ...
  { id: 'c29', text: 'AI 툴(ChatGPT, 미드저니 등)을 마케팅이나 콘텐츠 제작에 활용해본 적이 있다', category: 'tools',
    jobs: [{ job: 'content', weight: 1 }, { job: 'brand', weight: 1 }, { job: 'growth', weight: 1 }] },
